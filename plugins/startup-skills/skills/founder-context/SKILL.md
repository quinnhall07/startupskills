...
- `${CLAUDE_PLUGIN_ROOT}/references/composed/founder-resilience-protocols.md` — runway floor, sustainable pace check.
- `${CLAUDE_PLUGIN_ROOT}/references/composed/aggressive-consultation-archetype.md` — voice.
